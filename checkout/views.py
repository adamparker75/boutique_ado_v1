...
def checkout(request):
    ...
    if request.method == 'POST':
        ...
        # If the order form is valid we save the order
        if order_form.is_valid():
            # Commit=False prevents multiple save events being executed on the db
            ...
            for item_id, item_data in bag.items():
                try:
                    ...
                    # If it's an integer we just work with item_data
        ...
        # Using default delivery info to prefill the checkout form
